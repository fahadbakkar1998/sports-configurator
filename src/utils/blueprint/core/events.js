...
export const EVENT_FPS_EXIT = 'FPS_EXIT_EVENT';
...
export const EVENT_ROOM_NAME_CHANGED = 'ROOM_NAME_CHANGED_EVENT';
...
export const EVENT_CORNER_2D_CLICKED = 'EVENT_CORNER_2D_EVENT';
export const EVENT_WALL_2D_CLICKED = 'WALL_2D_CLICKED_EVENT';
export const EVENT_ROOM_2D_CLICKED = 'ROOM_2D_CLICKED_EVENT';

export const EVENT_CORNER_2D_DOUBLE_CLICKED = 'CORNER_2D_DOUBLE_CLICKED_EVENT';
export const EVENT_WALL_2D_DOUBLE_CLICKED = 'WALL_2D_DOUBLE_CLICKED_EVENT';
export const EVENT_ROOM_2D_DOUBLE_CLICKED = 'ROOM_2D_DOUBLE_CLICKED_EVENT';

export const EVENT_CORNER_2D_HOVER = 'CORNER_2D_HOVER_EVENT';
export const EVENT_WALL_2D_HOVER = 'WALL_2D_HOVER_EVENT';
export const EVENT_ROOM_2D_HOVER = 'ROOM_2D_HOVER_EVENT';

export const EVENT_CORNER_2D_MOVED = 'CORNER_2D_MOVED_EVENT';
