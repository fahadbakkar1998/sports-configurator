...
//			let s = this.wall.start.location;
//			let e = this.wall.end.location;
//			
////			let avect = this.wall.a.clone().sub(this.wall.start);
////			let bvect = this.wall.b.clone().sub(this.wall.start);
//			
//			let sevect = s.clone().sub(e).normalize();
//			let se90plus = sevect.clone().rotateAround(o, 3.14*0.5).multiplyScalar(this.wall.thickness*0.5);
//			let se90minus = sevect.clone().rotateAround(o, -3.14*0.5).multiplyScalar(this.wall.thickness*0.5);
//			
//			let s1 = se90plus.clone().add(s);
//			let e1 = se90plus.clone().add(e);
//			let e2 = se90minus.clone().add(e);
//			let s2 = se90minus.clone().add(s);
//			
//			curves.push([s1]);
...
//	}
	...
	{
		let v1startX=0.0, v1startY=0.0, v1endX=0.0, v1endY=0.0;
		let v2startX=0.0, v2startY=0.0, v2endX=0.0, v2endY=0.0;
