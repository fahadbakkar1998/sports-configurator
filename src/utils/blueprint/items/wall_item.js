...
export class WallItem extends Item
{
	...
	placeInRoom()
	{
		...
		if (!this.position_set)
		{
			...
			let newPos = new Vector3(center.x, closestWallEdge.wall.height / 2.0, center.y);
...
//		wallEdge.wall.fireOnDelete(this.remove.bind(this));
		...
		let normal3 = wallEdge.plane.geometry.faces[0].normal;
		normal2.x = normal3.x;
		normal2.y = normal3.z;

		let angle = Utils.angle( new Vector2(this.refVec.x, this.refVec.y), new Vector2(normal2.x, normal2.y));
