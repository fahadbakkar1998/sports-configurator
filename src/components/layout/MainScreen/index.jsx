...
const MainScreen = ({ breadcrumb }) => {
  ...
  const initEnvironment = async () => {
    ...
    screenRef.current.appendChild(renderer.domElement);
    ...
    camera = new THREE.PerspectiveCamera(
      cameraSetting.fov,
      screenRef.current.clientWidth / screenRef.current.clientHeight,
      cameraSetting.near,
      cameraSetting.far,
    );
  ...
  const onWindowResize = () => {
    ...
    camera.left = -screenRef.current.clientWidth / cameraSetting.factor;
    camera.right = screenRef.current.clientWidth / cameraSetting.factor;
    camera.top = screenRef.current.clientHeight / cameraSetting.factor;
    camera.bottom = -screenRef.current.clientHeight / cameraSetting.factor;
    renderer.setSize(
      screenRef.current.clientWidth,
      screenRef.current.clientHeight,
    );
